...
export type RoundTickEvent = { event: 'round_tick'; sessionId: string; round: number; userInput: string; timestamp: string; eventId: string }

export function normalizeRoundTick(input: any, previousRound = 0): RoundTickEvent {
